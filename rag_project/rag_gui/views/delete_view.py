...
class DeleteView(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.browse_type_combo.currentTextChanged.connect(lambda: self.refresh_statistics(silent=False))
        ...
        filter_layout.addWidget(self.browse_type_combo, stretch=1, alignment=QtCore.Qt.AlignVCenter)
        ...
        h_header.setSectionResizeMode(0, QtWidgets.QHeaderView.ResizeToContents) # Checkbox
        ...
        h_header.setSectionResizeMode(3, QtWidgets.QHeaderView.ResizeToContents) # Created
    ...
    def on_delete_finished(self, count: int):
        ...
        self.set_loading(False)
        QtWidgets.QMessageBox.information(self, "Success", f"Successfully deleted {count} documents.")
