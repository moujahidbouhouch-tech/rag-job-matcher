...
DB_PORT = int(
    _env_first(
        ["POSTGRES_PORT_RAG", "POSTGRES_PORT", "DB_POSTGRESDB_PORT", "DB_PORT"], "5433"
    )
)
DB_NAME = _env_first(
    ["POSTGRES_DB_RAG", "POSTGRES_DB", "DB_POSTGRESDB_DATABASE", "DB_NAME"], "rag"
)
DB_USER = _env_first(
    ["POSTGRES_USER_RAG", "POSTGRES_USER", "DB_POSTGRESDB_USER", "DB_USER"], "rag"
)
DB_PASS = _env_first(
    [
